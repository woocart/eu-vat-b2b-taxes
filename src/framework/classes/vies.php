...
namespace Niteo\WooCart\BetterTaxHandling {
	...
	class Vies {
		 ...
		 * Class constructor.
		 *
		 * @param Client|null $client Client for the VIES web service
		 */
		 ...
		 * @param bool   $checkExistence In addition to checking the VATIN's format for validity, also check whether the VATIN exists. This requires a call to the VIES web service.
		 *
		 * @return bool
		 */
