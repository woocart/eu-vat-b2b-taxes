			...
			<table class="widefat">
				<thead>
					<tr>
						...
						<th><strong><?php esc_html_e( 'Number Of Transactions', 'better-tax-handling' ); ?></strong></th>
						<th><strong><?php esc_html_e( 'Total Taxable Sales', 'better-tax-handling' ); ?></strong></th>
						<th><strong><?php esc_html_e( 'Total Tax Collected', 'better-tax-handling' ); ?></strong></th>
					</tr>
				</thead>
				<tbody>
