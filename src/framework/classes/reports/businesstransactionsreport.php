...
namespace Niteo\WooCart\BetterTaxHandling\Reports {
	...
	class Business_Transactions_Report extends WC_Admin_Report {
		...
		public function get_export_button() {
			...
			<a
				...
				data-export="table"
			>
				<?php esc_html_e( 'Export CSV', 'better-tax-handling' ); ?>
			</a>
			<?php
		}
		...
		public function get_main_chart() {
			...
			<table class="widefat">
				<thead>
					<tr>
						<th><strong><?php esc_html_e( 'Country', 'better-tax-handling' ); ?></strong></th>
						<th><strong><?php esc_html_e( 'Date', 'better-tax-handling' ); ?></strong></th>
						<th><strong><?php esc_html_e( 'Order Number', 'better-tax-handling' ); ?></strong></th>
						<th><strong><?php esc_html_e( 'Tax ID', 'better-tax-handling' ); ?></strong></th>
						<th><strong><?php esc_html_e( 'Amount Sales', 'better-tax-handling' ); ?></strong></th>
					</tr>
				</thead>
				<tbody>
